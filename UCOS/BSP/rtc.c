...
{	 
    ...
    pTimeAndDate->year     = 2000;                                        /* 初始化年  等价于   (*pTimeAndDate).year     = 2018;                         */	
    pTimeAndDate->month    = 1;                                           /* 初始化月                     */
    pTimeAndDate->day      = 1;                                           /* 初始化日                     */
    pTimeAndDate->week     = 1;                                           /* 初始化周                     */
    pTimeAndDate->hour     = 0;                                           /* 初始化时                     */
    pTimeAndDate->minute   = 0;                                           /* 初始化分                     */
    pTimeAndDate->second   = 0;                                           /* 初始化秒                     */      	
} 
